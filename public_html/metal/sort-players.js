...
document.getElementById ('col-wolf').addEventListener ('click',
    event => {sortTable (tableToSort,  2 * 3, -1, 'num');});
document.getElementById ('col-ant').addEventListener ('click',
    event => {sortTable (tableToSort,  3 * 3, -1, 'num');});
document.getElementById ('col-skunk').addEventListener ('click',
    event => {sortTable (tableToSort,  4 * 3, -1, 'num');});
document.getElementById ('col-raccoon').addEventListener ('click',
    event => {sortTable (tableToSort,  5 * 3, -1, 'num');});
document.getElementById ('col-elephantor').addEventListener ('click',
    event => {sortTable (tableToSort,  6 * 3, -1, 'num');});
document.getElementById ('col-hamster').addEventListener ('click',
    event => {sortTable (tableToSort,  7 * 3, -1, 'num');});
document.getElementById ('col-points').addEventListener ('click',
